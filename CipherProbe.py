...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.CipherProbe/sessions/'
        self.pixiewps_dir = f'{user_home}/.CipherProbe/pixiewps/'
...
def usage():
    return """
CipherProbe by immature_fetus21st, (C) NULLBASH SECURITY 2024
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='CipherProbe by immature_fetus21st, (C) NULLBASH SECURITY 2024',
